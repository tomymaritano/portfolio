    ...
    <PageTransition>
      <PageFrame className="pt-10 pb-24">
        <Reveal>
          ...
          <h1 className="mt-2 text-[2rem] leading-tight font-medium tracking-tight">How this is made.</h1>
          <p className="prose-work mt-6 text-[16px] leading-7 text-foreground/85">
            A case is a file and a folder of stills. Next.js, Tailwind, MDX in git. Headlines are
            Newsreader, body is IBM Plex Sans, labels are IBM Plex Mono. Notes can also
